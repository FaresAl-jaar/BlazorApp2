...
| 🔓 | Freigeben | Reservierung aufheben |
| ✏️ | Bearbeiten | Dokumenteneditor öffnen |
| 👁️ | Ansehen | Nur-Lesen-Modus |
| ⬇️ | Download | JSON herunterladen |
| 🗑️ | Löschen | Dokument entfernen |
...
4. Status wechselt zu "Übermittelt".
...
Verwenden Sie diesen Endpunkt für manuelle Uploads oder Tests.
```
...
#### PDF als Base64 (JSON)
Verwenden Sie diesen Endpunkt für die Anbindung an Lobster/Externe Systeme.
```
